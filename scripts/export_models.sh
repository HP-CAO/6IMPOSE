...
python main.py --config ./logs/frontiers_stapler_512/config.json --id frontiers_stapler_512_export --params trainer_params/distribute_train_device 1 monitor_params/sim2real_eval false --force --weights ./models/frontiers_stapler_512/25/model --mode export
python main.py --config ./logs/frontiers_pliers_512/config.json --id frontiers_pliers_512_export --params trainer_params/distribute_train_device 1 monitor_params/sim2real_eval false --force --weights ./models/frontiers_pliers_512/25/model --mode export
...
python main.py --config ./logs/frontiers_cpsglue_512/config.json --id frontiers_cpsglue_512_export --params trainer_params/distribute_train_device 1 monitor_params/sim2real_eval false --force --weights ./models/frontiers_cpsglue_512/25/model --mode export
python main.py --config ./logs/frontiers_chew_toy_512/config.json --id frontiers_schew_toy_512_export --params trainer_params/distribute_train_device 1 monitor_params/sim2real_eval false --force --weights ./models/frontiers_chew_toy_512/25/model --mode export
