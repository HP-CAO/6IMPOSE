...
python main.py --config ./config/sim2real_pvn3d.json --id frontiers_stapler --params dataset_params/data_name cps dataset_params/cls_type cpsglue trainer_params/distribute_train_device 4 monitor_params/sim2real_eval false --force &
python main.py --config ./config/sim2real_pvn3d.json --id frontiers_stapler --params dataset_params/data_name cps dataset_params/cls_type wrench_13 trainer_params/distribute_train_device 5 monitor_params/sim2real_eval false --force &
python main.py --config ./config/sim2real_pvn3d.json --id frontiers_stapler --params dataset_params/data_name cps dataset_params/cls_type chew_toy trainer_params/distribute_train_device 6 monitor_params/sim2real_eval false --force &
python main.py --config ./config/sim2real_pvn3d.json --id frontiers_stapler --params dataset_params/data_name cps dataset_params/cls_type pliers trainer_params/distribute_train_device 7 monitor_params/sim2real_eval false --force
