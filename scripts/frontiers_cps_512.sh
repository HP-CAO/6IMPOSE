...
#python main.py --config ./config/sim2real_pvn3d.json --id frontiers_stapler_512_sup --params dataset_params/data_name cps dataset_params/cls_type stapler trainer_params/distribute_train_device 6 monitor_params/sim2real_eval false pvn3d_params/point_net2_params/n_sample_points 512 --force &
#python main.py --config ./config/sim2real_pvn3d.json --id frontiers_cpsglue_512_sup --params dataset_params/data_name cps dataset_params/cls_type cpsglue trainer_params/distribute_train_device 7 monitor_params/sim2real_eval false pvn3d_params/point_net2_params/n_sample_points 512 --force &
...
python main.py --config ./config/sim2real_pvn3d.json --id frontiers_chew_toy_512_sup_2 --params dataset_params/data_name cps dataset_params/cls_type chew_toy trainer_params/distribute_train_device 6 monitor_params/sim2real_eval false pvn3d_params/point_net2_params/n_sample_points 512 &
python main.py --config ./config/sim2real_pvn3d.json --id frontiers_pliers_512_sup_2 --params dataset_params/data_name cps dataset_params/cls_type pliers trainer_params/distribute_train_device 7 monitor_params/sim2real_eval false pvn3d_params/point_net2_params/n_sample_points 512
